  ...
  return `
    <div dir="rtl" class="text-sm leading-6 text-right">
      ...
      <div class="mt-3">
        ...
        ניתן למצוא יועץ/ת דרך כפתור "בחירת נושא" שבראש הצ׳אט
      </div>
    </div>`;
}
    ...
    schema: {
      ...
      function: {
        ...
        description:
          ...
          "כולל גם את ההנחיות הכלליות לרישום ממוחשב (aspect=rules): מגבלות נ\"ז בסמסטר, חפיפת מועדי בחינות, " +
          "קבוצות 'מיועד לחוזרים', התגברות על חסימות ברישום, שמירת סילבוסים והדפסת מערכת השעות. " +
          "השתמש לשאלות על תהליך הרישום, מועדיו וכלליו. " +
        ...
        parameters: {
          ...
          properties: {
            ...
            aspect: {
              type: "string",
              enum: ["window", "advisors", "mentors", "credits", "links", "internship", "exemptions", "contacts", "labs", "rules", "general"],
              description:
                ...
                "contacts=אנשי קשר לרישום, labs=מי איש הקשר האחראי על המעבדות (לא רשימת המעבדות), " +
                "rules=ההנחיות והכללים לרישום עצמו (מה מותר/אסור, מגבלות, המלצות תפעוליות), general=כללי.",
            },
          },
          required: ["aspect"],
        },
